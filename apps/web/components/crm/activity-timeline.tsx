...
const typeConfig: Record<ActivityType, { icon: React.ElementType; color: string; label: string }> = {
  note: { icon: MessageSquare, color: "bg-blue-100 text-blue-600 dark:bg-blue-950/50 dark:text-blue-300", label: "Note" },
  call: { icon: Phone, color: "bg-green-100 text-green-600 dark:bg-green-950/50 dark:text-green-300", label: "Call" },
  email: { icon: Mail, color: "bg-purple-100 text-purple-600 dark:bg-purple-950/50 dark:text-purple-300", label: "Email" },
  meeting: { icon: Calendar, color: "bg-orange-100 text-orange-600 dark:bg-orange-950/50 dark:text-orange-300", label: "Meeting" },
  system: { icon: Zap, color: "bg-gray-100 text-gray-600 dark:bg-gray-800/60 dark:text-gray-300", label: "System" },
};
