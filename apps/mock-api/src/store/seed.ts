  ...
  const dealList: Deal[] = [
    {
      ...
      lead_id: "l1111111-1111-1111-1111-111111111111",
    ...
    },
    {
      ...
      lead_id: "l2222222-2222-2222-2222-222222222222",
      ...
      site_assessment_date: formatDate(daysAgo(5)),
      site_assessment_location: "Bengaluru Tech Park",
      site_assessment_notes: "On-site assessment complete. High compatibility with infrastructure.",
      lost_reason: null,
    ...
    },
    {
      ...
      lead_id: "l3333333-3333-3333-3333-333333333333",
      stage: "site_assessment" as const,
      amount: 7500000,
      ...
      site_assessment_date: formatDate(new Date(Date.now() + 86400000 * 2).toISOString()),
      site_assessment_location: "Mumbai HDFC HQ",
      site_assessment_notes: "Scheduled site visit to audit data center deployment.",
      lost_reason: null,
    ...
    },
    {
      ...
      lead_id: "l4444444-4444-4444-4444-444444444444",
      stage: "won" as const,
      amount: 4500000,
      product_use_case: "On-demand routing agent automation during festive sales.",
      probability: 100,
      next_action: "Handover to Implementation Team",
      site_assessment_date: formatDate(daysAgo(15)),
      site_assessment_location: "Flipkart Warehouse, Hoskote",
      site_assessment_notes: "Fulfilled site assessment requirements.",
      lost_reason: null,
